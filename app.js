...
async function runMigrationsAndCleanup() {
    ...
    // ===== ONE-TIME FIX: Missing tasks for April 27th =====
    if (!appData.stats.fixApril27_v1) {
        appData.stats.fixApril27_v1 = true;
        needsSave = true;
        ...
        const fixTimestamp = '2026-04-28T03:00:00.000Z'; // April 27 10PM CDT
        ...
        tasksToFix.forEach(task => {
            ...
            const has = appData.completedHistory.some(h => {
                ...
                return getDateString(d) === '2026-04-27';
            });
            if (!has) {
                appData.completedHistory.unshift({
                    id: 'recurring_' + task.id + '_fix_apr27',
