...
async function runMigrationsAndCleanup() {
    ...
    // ===== ONE-TIME FIX: Missing tasks for April 25th =====
    if (!appData.stats.fixApril25_v1) {
        appData.stats.fixApril25_v1 = true;
        needsSave = true;
        ...
        const fixTimestamp = '2026-04-26T03:00:00.000Z'; // April 25 10PM CDT
        ...
        tasksToFix.forEach(task => {
            ...
            const has = appData.completedHistory.some(h => {
                ...
                return getDateString(d) === '2026-04-25';
            });
            if (!has) {
                appData.completedHistory.unshift({
                    id: 'recurring_' + task.id + '_fix_apr25',
